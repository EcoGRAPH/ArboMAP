...
* there are multiple (>3) years of infection data from years in which the pathogen can be considered endemic, after any introductory years in which the pathogen is probably exploiting naive populations and should not be considered established
* the disease has distinct transmission and quiescent seasons, including an initial, yearly exponential growth phase when the pathogen is beginning to spread after a period of few or no cases
...
The measure of pathogen in the environment will probably be something like we use here, a list of 
