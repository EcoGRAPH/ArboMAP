...
mosquitobelievableyears <- c(2003:2010, 2012:2018)
...
If you believe human data in a year and either 1) do not believe the mosquito data from that year or 2) are not able to obtain an estimated mosquito infection growth rate for that year (e.g. too few mosquito pools reported), then ArboMAP will substitute the mosquito data with a single constant for that risk. This allows us to estimate relationships with environmental data even when mosquito data are not available.
