...
modeltype <- "fixeddfcr"
if (!(modeltype %in% c("fixeddfcr", "thinplate"))) { modeltype <- "fixeddf" }
...
ggplot(lag1df) + geom_line(aes(x=x, y=fit, group=name, stratum=name))
ggplot(lag2df) + geom_line(aes(x=x, y=fit, group=name, stratum=name))
```
