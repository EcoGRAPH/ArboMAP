...
modeltype <- "fixeddfcr"
if (!(modeltype %in% c("fixeddfcr", "thinplate"))) { modeltype <- "fixeddfcr" }
...
relationship <- gam(totobs ~ s(anyobs), data=byyear)
