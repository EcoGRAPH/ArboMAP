...
params:
  state_name: "Oklahoma"
  state_code: "OK"
  forecast_date: "2018-07-22"
  data_path: ".\\"
  human_file: "ok human case data.csv"
  mosquito_file: "OKmosqdata_02_12_2021.csv"
  stratification_file: NA
  predictor_v1: "tmeanc"
  predictor_v2: "vpd"
  mosquito_model: "AUC"
  min_human_year: 2004
...
humandatafile <- paste0(params$data_path, "human case data\\", params$human_file)
...
weatherpathstr <- paste0(params$data_path, "weather data\\")
...
mosqfile <- paste0(params$data_path, "mosquito data\\", params$mosquito_file)
...
resamplemosquitodata <- FALSE
resamplemosquitodatafile <- "./mosquito data/simulated mosquito tests.csv"
...
if (mosqsummarystyle %in% c("stratifiedMIGR", "stratifiedMII")) {
  ...
  # read stratum file
  stratafile <- paste0(params$data_path, "spatial stratification\\",
...
kable(param_table[c(1:3, 5:nrow(param_table)),], 
