...
# temporarily disable outputs, as these cause problems on some platforms
...
minenvbelieveyear <- 2003
maxenvbelieveyear <- 2019
...
maxdesiredhumandate <- as.Date(paste(maxhumandesiredyear, "12-31", sep=""))
...
mindesiredhumandate <- as.Date(paste(minhumandesiredyear, "12-31", sep=""))
mindesiredhumandate <- mindesiredhumandate - (as.numeric(strftime(mindesiredhumandate, '%u')) %% 7)
mindesiredhumandatestr <- strftime(mindesiredhumandate, '%A')
