...
if (splineevolution == "seasonallyvarying") {
  ...
  #fullcasemat$sindoy <- sin(2*3.1415927*(fullcasemat$doymat - 1) / 365)
  #fullcasemat$cosdoy <- cos(2*3.1415927*(fullcasemat$doymat - 1) / 365)
...
if (splineevolution == "seasonallyvarying") {
  ...
  termdf$var1inf <- termdf[,grep(x=colnames(termdf),
                                      pattern="var1",
                                      fixed=TRUE)]
  termdf$var2inf <- termdf[,grep(x=colnames(termdf),
                                      pattern="var2",
                                      fixed=TRUE)]
  termdf <- group_by(termdf,
                     year,
