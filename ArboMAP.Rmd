...
graphicoutputdir <- "D:\\work\\git\\WNV\\packaged WNV\\graphical outputs\\"
fullcasematoutputdir <- "D:\\work\\git\\WNV\\packaged WNV\\case matrix with estimates\\"
...
weekinquestion <- as.Date("2018-07-29", "%Y-%m-%d")

# where are the gridmet csv files stored?
gridmetpathstr <- "D:\\work\\git\\WNV\\packaged WNV\\gridMet\\"
...
stratafile <- "D:\\work\\git\\WNV\\packaged WNV\\strata\\17-04-20 - classified strata - classic.csv"

# where is the countyshapefile
countyshapefile <- "D:\\work\\git\\WNV\\packaged WNV\\shapefile\\cb_2014_us_county_5m - in EPSG 5070 - only SD.shp"
...
ggplot(data=mosqmopreds) + geom_line(data=mosqmopreds, aes(x=doy, y=preds, group=year), color="grey", alpha=0.5) +
