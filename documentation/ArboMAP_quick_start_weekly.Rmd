...
1. Update mosquito data - the latest mosquito pool data with positive or negative WNV test results will need to be appended to the mosquito CSV data file, in the `data_mosquito` folder, with these fields: 
...
3. Run the forecast:
    ...
    2. In the File pane of RStudio, click on the appropriate run script: `ArboMAP_run_forecast_pdf.R` for a pdf report or `ArboMAP_run_forecast_html.R` for an html file. 
    3. In the Source pane that opens, make sure the cursor is on line 1 and hit the 'Run" button. 
    
    ```{r run-pdf, echo=FALSE, fig.align='center', out.width='80%', fig.cap="Source pane for the pdf run script."}
