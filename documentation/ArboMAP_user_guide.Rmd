...
* `year_mosquito_end`: End year of mosquito data to use.
...
<<>>Get human data previous year, add to human csv file (one file)
...
<<>>
Run GEE app (or script) to gather weather data from the end of last forecast season (or whenever weather data was last updated) through current. 
