...
humandatafile <- "C:\\home\\work\\davis\\WNV repository\\Oklahoma\\human case data\\ok human case data.csv"
...
mosquitobelievableyears <- c(2004:2019)
mosquitobelievableyears <- c(2012:2019)
...
weekinquestion <- as.Date("2019-10-01", "%Y-%m-%d")

# where are the weather csv files stored?
weatherpathstr <- "C:\\home\\work\\davis\\WNV repository\\Oklahoma\\Weather\\"
...
mosqfile <- "C:\\home\\work\\davis\\WNV repository\\Oklahoma\\mosquito data\\okmosqdata - with edges2.csv"


# declare which summary statistic will be used to create the MIRsummarystat
mosqsummarystyle <- "MII"
