...
```{r appx_dep_fxs, include=TRUE, echo=FALSE, fig.align='center', results='asis', fig.width=5, fig.height=3}
...
# I believe I can all these 'partial effects' [DMN]
# [DMN] useful refs: 
...
# [V3] here pulls the data table out of the plot to replot nicer
...
for (i in seq_along(model_names)){
  ...
  for (j in seq_along(this_plot)){
    ...
    # I believe all production ArboMAP plots will be 1-D [DMN]
