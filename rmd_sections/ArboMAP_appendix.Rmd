...
```{r appx_multiyr_forecast, echo=FALSE, include=TRUE, fig.align='center', out.width="100%"}
...
```{r appx_dep_fxs, include=TRUE, echo=FALSE, fig.align='center', out.width="100%", results='asis'}
