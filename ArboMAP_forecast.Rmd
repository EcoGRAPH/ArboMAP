...
params:
  ...
  # developer settings
  #dev_settings: !r list() 
  dev_settings: !r list(dev_write_output = TRUE, model_evaluation = TRUE, out_folder = file.path("dev", "20220328"))
...
```{r current_year_forecast, echo=FALSE, include=TRUE, fig.align='center', out.width="100%"}
...
```{r positives_to_cases, echo=FALSE, include=TRUE, fig.align='center', out.width="100%"}
...
```{r mosquito_pools, out.width="100%", echo=FALSE, include=TRUE}
...
```{r weather_charts, echo=FALSE, include=TRUE, fig.align='center', out.width="100%", fig.height=c(3,4,3,5)}
...
```{r human_map, echo=FALSE, include=TRUE, fig.align='center', out.width="100%"}
