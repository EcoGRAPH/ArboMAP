...
```{r figure_dimensions_sizes, echo=FALSE, include=FALSE, cache=FALSE}
...
#If highlight counties, then add special secondary map and table
if (highlight_flag){
  ...
  if (!highlight_mask){
    ...
    p_abs_risk_high <- p_abs_risk + 
      geom_sf(data = sf_highlight,
              ...
              size = 1,
              #let the pred_ave colors through
              fill = NA) +
      scale_color_manual("", 
