...
pos_case_preds_ave <- pred_yrs_fc_yr %>% 
  ...
  #strings for table
  # rounding mostly to ceiling because you cannot have a fractional case (in reality)
  dplyr::mutate(range_pred_cases = paste0(round_any(min_tot_pred_cases, 1, floor), 
