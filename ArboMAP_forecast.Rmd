...
Parameters were set to include weather data from `r params$year_weather_start` through `r params$year_weather_end`, and there were `r length(env_yrs_missing)` years not found in the given data. `r if(length(env_yrs_missing)>0){paste("The following years were not found in the dataset:", env_yrs_missing, ".")}`
