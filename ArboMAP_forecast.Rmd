...
params:
  ...
  # developer settings
  #dev_settings: !r list() 
  dev_settings: !r list(dev_write_output = TRUE, model_evaluation = TRUE, out_folder = file.path("dev", "20220322"))
...
pacman::p_load(
  ...
  tigris, sf, ggplot2, gridExtra, viridis, ggrepel,
...
p_env_var1_color <- ggplot() + 
  ...
  ggtitle(paste("Environmental data for", params$predictor_var1, 
                "in", max(data_env$year_epi, na.rm=TRUE))) +
  theme_arbo_chart 
  #theme(legend.position = "bottom") #displayed in second chart
