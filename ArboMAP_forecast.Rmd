...
if (nrow(data_mosq_yr2wk) > 0){
  knitr::kable(data_mosq_yr2wk %>% 
                 ...
                 #make pretty %
                 dplyr::select(NAME, 
                               pools_count, pools_pos, pools_pos_perc_pretty,
                               pools_count_yr, pools_pos_yr, pools_pos_yr_perc_pretty) %>% 
                 dplyr::arrange(NAME),
               col.names = c("County", 
                             "Pools reported last 2 weeks", "Pools positive last 2 weeks", "Percent positive last 2 weeks", 
                             "Pools reported YTD", "Pools positive YTD", "Percent positive YTD"),
               digits = 1,
