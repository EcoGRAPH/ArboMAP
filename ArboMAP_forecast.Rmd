...
```{r reference_map, echo=FALSE, include=TRUE, fig.align='center', out.width='100%'}
#Creates a reference map of county names

#fig.width=if (sf_wider) 10 else 7.5: [DEV] not working? landscape picture less than 10
