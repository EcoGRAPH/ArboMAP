...
env_dates <- seq.Date(from = as.Date(paste0(params$year_modeling_start, "-01-01"), 
...
`r if(length(env_missing_dates) == 0){paste0("Data from all days in all years were found in the data file. ")}`
`r if(length(env_missing_dates) > 0){paste0("The following days were not found in the dataset:", env_missing_dates %>% sort() %>% stringr::str_c(collapse=", "), ".")}`
