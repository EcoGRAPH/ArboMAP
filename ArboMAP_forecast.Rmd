...
# Many of the plots displayed in the main report are the AVERAGE of all models, 
#   so creating summary here for use in multiple places 

#DEV test #filter(arbo_ID == 'anley', date_epi == as.Date("2018-10-20"))
...
# #<<>><<>> DEV ??????? why replace year sums of preds that are > 1 with a linear approx? how is this current week?? Is this code just wrong?? [DMN]
# 
