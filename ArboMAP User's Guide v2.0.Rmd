...
* cases of disease are assigned to areal units (states, counties, etc.) and cases are not too rare - every modeled spatialunit should have at least one case over the period of study, as the model will assume an area is permanently immune if no cases have been observed there
