...
Next are the absolute probabilities of each district reporting at least one human case during the week in question. If the district is darkest blue, then the model says there is no probability of reporting a case during the week you've selected. This is often the case in the early or late seasons, especially in the lower-population counties. If a district is brightest red, then the model says the district will definitely report at least one human case this week.
...
ArboMAP also includes an `ArboMAP Variable Selection.Rmd` file, with settings that are almost exactly the same as the `ArboMAP User's Guide.Rmd` file. However, this file will run through all available pairs of covariates and 
